      ...
      <div className="mb-8">
        ...
        <div className="bg-gray-900/60 border border-gray-800 rounded-lg p-6">
          <div className="flex items-center">
            <Award size={40} className="text-secondary mr-4" />
            <div>
              <h3 className="text-lg font-semibold text-white">Course Completion</h3>
              <p className="text-gray-400">You completed "Forex Trading Fundamentals"</p>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-800">
            <p className="text-sm text-gray-400 mb-2">Keep going! Complete more courses to earn achievements.</p>
            <Link to="/dashboard/my-courses">
