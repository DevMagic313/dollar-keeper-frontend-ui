            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between pb-4 border-b border-gray-800">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Get notified when courses you're enrolled in are updated</p>
                </div>
              ...
              <div className="flex items-center justify-between pb-4 border-b border-gray-800">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Get notified when new courses are added in your areas of interest</p>
                </div>
                <Switch defaultChecked />
              </div>
              ...
              <div className="flex items-center justify-between pb-4 border-b border-gray-800">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Receive notifications about discounts and special offers</p>
                </div>
                <Switch />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Weekly newsletter with trading tips and market insights</p>
                </div>
                <Switch defaultChecked />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-gray-800">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Videos will automatically play when you open a lesson</p>
                </div>
                <Switch />
              </div>
